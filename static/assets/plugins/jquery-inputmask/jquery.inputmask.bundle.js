...
!function($) {
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function mousecertificateEvent(e) {
            var input = this;
        ...
        function mask(elem) {
            ...
            EventRuler.on(el, "blur", blurEvent), EventRuler.on(el, "focus", focusEvent), EventRuler.on(el, "mousecertificate", mousecertificateEvent), 
