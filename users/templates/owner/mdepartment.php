...
<meta charset="utf-8" />
  ...
  <title>
    Manage Dept. | College e-Certification
  </title>
  <!--     Fonts and icons     -->
        ...
        <li class="nav-item">
          ...
          <div class="menu-collapse">
                            <ul style="list-style-type: none">
                                ...
                                <li class="nav-link-text ms-1"><a class="nav-link text-white active bg-gradient-primary" href="../admin/mdepartment">Manage Department</a></li>
                            </ul>
                        </div>
        </li>
        <li class="nav-item">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Manage Department</h6>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Dept. Short Name</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Department Code</th>
...
{               ?>  
                    <tr>
                      ...
                      <td class="text-sm font-weight-bold mb-0"><?php echo htmlentities($result->DepartmentName);?></td>
                      <td class="text-sm font-weight-bold mb-0"><?php echo htmlentities($result->DepartmentShortName);?></td>
                      <td class="text-sm font-weight-bold mb-0"><?php echo htmlentities($result->DepartmentCode);?></td>
                      <td class="text-sm font-weight-bold mb-0"><?php echo htmlentities($result->CreationDate);?></td>
                      <td class="text-sm font-weight-bold mb-0">
                      <a href="edepartment.php?deptid=<?php echo htmlentities($result->id);?>"><i class="material-icons edit_icon">mode_edit</i></a><a href="mdepartment.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="material-icons delete_icon">delete_forever</i></a>
                      </td>
