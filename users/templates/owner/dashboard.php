...
<?php
$sql = "SELECT id from  tcertificatetype";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo htmlentities($dptcount);?></h4>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><?php echo htmlentities($leavtypcount);?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Certificate Type</th>
                  ...
                  <tbody>
                  <?php $sql = "SELECT tcertificate.id as lid,tstudent.FirstName,tstudent.LastName,tstudent.Sid,tstudent.id,tcertificate.CertificateType,tcertificate.PostingDate,tcertificate.Status from tcertificate join tstudent on tcertificate.Sid=tstudent.id order by lid desc limit 6";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
      ...
      ?> 
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="editstudent.php?Sid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->FirstName." ".$result->LastName);?>(<?php echo htmlentities($result->Sid);?>)</a>
                        </div>
                      </td>
                      <td class="text-sm font-weight-bold mb-0">
                      <?php echo htmlentities($result->CertificateType);?>
                      </td>
...
<a class="text-white" href="cdetails.php?Certificateid=<?php echo htmlentities($result->lid);?>"> View Details</a>
</span>
                      </td>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://iT_Creation.in" class="font-weight-bold" target="_blank">iT_Creation</a>
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://iT_Creation.in" class="nav-link text-muted" target="_blank">iT_Creation</a>
                </li>
                <li class="nav-item">
                  <a href="https://iT_Creation.in/presentation" class="nav-link text-muted" target="_blank">About Us</a>
                </li>
                <li class="nav-item">
                  <a href="https://iT_Creation.in/blog" class="nav-link text-muted" target="_blank">Blog</a>
                </li>
                <li class="nav-item">
                  <a href="https://iT_Creation.in/license" class="nav-link pe-0 text-muted" target="_blank">License</a>
                </li>
              </ul>
            </div>
          </div>
