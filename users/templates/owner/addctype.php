...
$sql="INSERT INTO tcertificatetype(CertificateType,Description) VALUES(:Certificatetype,:description)";
...
if($lastInsertId)
{
$msg="Certificate type added Successfully";
}
else 
{
...
<head>
  ...
  <title>
    Add Certificates | College e-Certification
  </title>
  <!--     Fonts and icons     -->
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-flex d-none">
                <li class="nav-item d-flex align-items-center">
                  <a class="btn btn-outline-primary btn-sm mb-0 me-2" target="_blank" href="mcertificatetype">Manage Certificate Types</a>
                </li>
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              ...
              <?php if($error){?><div class="errorWrap"><strong>ERROR</strong> : <?php echo htmlentities($error); ?> </div><?php } 
                ...
                <div class="card-header">
                  <h4 class="font-weight-bolder">Add Certificate Type</h4>
                  <p class="mb-0">Enter valid certificate details...</p>
                </div>
                <div class="card-body">
                  <form role="form" name="chngpwd" method="post">
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label">Certificate Type / Name</label>
                      <input id="Certificatetype" type="text"  class="form-control validate" autocomplete="off" name="Certificatetype" required>
                    </div>
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label">Description</label>
                      <textarea id="textarea1" name="description" class="form-control validate" name="description" length="500"></textarea>
