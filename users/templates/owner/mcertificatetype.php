...
{
$id=$_GET['del'];
$sql = "delete from  tcertificatetype  WHERE id=:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_STR);
$query -> execute();
$msg="Certificate type record deleted";
...
<meta charset="utf-8" />
  ...
  <title>
    Manage Certificates | College e-Certification
  </title>
  <!--     Fonts and icons     -->
        ...
        <li class="nav-item">
          ...
          <div class="menu-collapse">
                            <ul style="list-style-type: none">
                                ...
                                <li class="nav-link-text ms-1"><a class="nav-link text-white active bg-gradient-primary" href="../admin/mcertificatetype">Manage Certificate Type</a></li>
                            </ul>
                        </div>
        </li>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Certificate Types</h6>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Certificate Type</th>
                  ...
                  <?php if($msg){?><div class="succWrap"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from tcertificatetype";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                    <tr>
                      ...
                      <td class="text-sm font-weight-bold mb-0"><?php echo htmlentities($result->CertificateType);?></td>
                      <td class="text-sm mb-0"><?php echo htmlentities($result->Description);?></td>
                      <td class="text-sm font-weight-bold mb-0"><?php echo htmlentities($result->CreationDate);?></td>
                      <td class="text-sm font-weight-bold mb-0">
                      <a href="ecertificatetype.php?lid=<?php echo htmlentities($result->id);?>"><i class="material-icons edit_icon">mode_edit</i></a><a href="mcertificatetype.php?lid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="material-icons delete_icon">delete_forever</i></a>
                      </td>
