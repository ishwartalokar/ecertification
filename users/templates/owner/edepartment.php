...
<meta charset="utf-8" />
  ...
  <title>
    Edit Dept. | College e-Certification
  </title>
  <!--     Fonts and icons     -->
...
{               ?> 
                <div class="card-header">
                  <h4 class="font-weight-bolder">Update Department</h4>
  ...
  <tr>
    <td class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Department Name</strong></td>
    <td class="text-dark">:&nbsp;</td>
    <td><input id="departmentname" type="text" autocomplete="off" name="departmentname" value="<?php echo htmlentities($result->DepartmentName);?>"  required class="validate"></td>
  </tr>
  <tr>
    <td><li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Dept. Short Name</strong></td>
    <td class="text-dark">:&nbsp;</td>
    <td><input id="departmentshortname" type="text"  autocomplete="off" name="departmentshortname"  value="<?php echo htmlentities($result->DepartmentShortName);?>" required class="validate"></td>
  </tr>
  <tr>
    <td><li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Department Code</strong></td>
    <td class="text-dark">:&nbsp;</td>
    <td><input id="deptcode" type="text" name="deptcode" autocomplete="off"  class="validate" value="<?php echo htmlentities($result->DepartmentCode);?>" required></td>
  </tr>
