...
<meta charset="utf-8" />
  ...
  <title>
    Pending Certificates | College e-Certification
  </title>
  <!--     Fonts and icons     -->
        ...
        <li class="nav-item">
          ...
          <div class="menu-collapse">
                            <ul style="list-style-type: none">
                                ...
                                <li class="nav-link-text ms-1"><a class="nav-link text-white active bg-gradient-primary" href="../admin/pchistory">Pending Certificates</a></li>
                            </ul>
                        </div>
        </li>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Pending Certificate history</h6>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <?php 
$status=0;
$sql = "SELECT tcertificate.id as lid,tstudent.FirstName,tstudent.LastName,tstudent.Sid,tstudent.id,tcertificate.CertificateType,tcertificate.PostingDate,tcertificate.Status from tcertificate join tstudent on tcertificate.Sid=tstudent.id where tcertificate.Status=:status order by lid desc";
